...
if flow == "🔍 Подобрать варианты по моим ЕГЭ":
    ...
    if not show_dvi:
        st.caption("💡 Не видите МГУ, МГИМО и другие топ-вузы? Включите показ специальностей с ДВИ — большинство их программ требуют дополнительное вступительное испытание в самом вузе.")
